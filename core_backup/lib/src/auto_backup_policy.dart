...
/// Pure scheduling rules for auto-backup. Checked whenever the app decides to
/// run (typically on launch/unlock); a backup is due when the last one is at
/// least one interval old.
abstract final class AutoBackupPolicy {
  /// When the next backup is due, or null when [interval] is off.
  /// A dataset that has never been backed up is due immediately.
